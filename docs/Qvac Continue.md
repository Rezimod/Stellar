...
- `docs/qvac-demo-script.md` — 75s demo shot list  
...
- Phase 2: public Expo+QVAC playbook ($4K), v0.2 with TTS + EN↔KA NMT + APK + video ($5K), upstream contribution + case study ($3K)  
