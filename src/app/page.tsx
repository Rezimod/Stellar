    ...
    <SideraShell>
        ...
        <div className="sd-container sd-hero__grid">
          <div>
            ...
            <h1 className="sd-display">
              The night sky,
              <br />
              issued in <span style={{ color: 'var(--sd-accent)' }}>editions</span>.
            </h1>
            <p className="sd-hero__sub">
              Twenty real objects — craters, planets, stars, nebulae. Each one a numbered edition. A telescope in
              Tbilisi photographs one of them a night, and everyone holding that card gets the photograph.
            </p>
            ...
            <div className="sd-stats">
              <div>
                <div className="sd-stat__n">{SET_001_CARDS.length}</div>
                <div className="sd-stat__l">Objects in Set 001</div>
              </div>
              <div>
                <div className="sd-stat__n">{editions.toLocaleString('en-GB')}</div>
                <div className="sd-stat__l">Numbered editions</div>
              </div>
              <div>
                <div className="sd-stat__n">{onSale || CARDS_PER_CAPSULE}</div>
      ...
      <section className="sd-band">
        <div className="sd-container">
          ...
          <h2 className="sd-page__title">Three cards, one telescope, a public ledger of every draw</h2>
      ...
      {node && (
        <section className="sd-container sd-section">
          <div className="sd-panel">
            ...
            <h2 className="sd-name">Node 01 — {node.name}, {node.site}</h2>
            <p className="sd-lede">
              A 150 mm telescope on a city roof under a Bortle {node.bortle} sky. It is being commissioned, so it has
              not begun its nightly run — and nothing here pretends otherwise. What it will and will not reach is
              already printed on every card in the set, object by object.
            </p>
      ...
      <section className="sd-band">
        <div className="sd-container" style={{ textAlign: 'center' }}>
          <h2 className="sd-display" style={{ maxWidth: '18ch', marginInline: 'auto' }}>
            Nothing here is a rendering.
          </h2>
          <p className="sd-lede" style={{ marginInline: 'auto', textAlign: 'center' }}>
            Every object on a card is somewhere overhead tonight, and every draw is written into a log anyone can read,
