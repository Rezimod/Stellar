    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-12 sm:py-20 text-text-primary">
      ...
      <div className="flex flex-col gap-6 text-[15px] leading-relaxed text-text-primary/80">
        ...
        <section className="flex flex-col gap-2">
          <h2 className="font-display text-xl text-text-primary">What we’ve done</h2>
        ...
        <section className="flex flex-col gap-2">
          <h2 className="font-display text-xl text-text-primary">Known limitations</h2>
          <p>
        ...
        <section className="flex flex-col gap-2">
          <h2 className="font-display text-xl text-text-primary">Report an issue</h2>
          <p>
            {'If you hit an accessibility barrier, please tell us so we can fix it. Email '}
            ...
            {' page. We aim to respond within five business days.'}
          </p>
        </section>
      </div>
    </div>
