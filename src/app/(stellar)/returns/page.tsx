    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-12 sm:py-20 text-text-primary">
      ...
      <div className="flex flex-col gap-6 text-[15px] leading-relaxed text-text-primary/80">
        ...
        <section className="flex flex-col gap-2">
          <h2 className="font-display text-xl text-text-primary">Return window</h2>
          <p>
        ...
        <section className="flex flex-col gap-2">
          <h2 className="font-display text-xl text-text-primary">Condition</h2>
          <p>
        ...
        <section className="flex flex-col gap-2">
          <h2 className="font-display text-xl text-text-primary">Stars redemptions</h2>
          <p>
        ...
        <section className="flex flex-col gap-2">
          <h2 className="font-display text-xl text-text-primary">Start a return</h2>
          <p>
            {'Email '}
            <a className="underline underline-offset-4" href="mailto:info@astroman.ge">info@astroman.ge</a>
            {' with your order number, or reach us from the '}
            <Link href="/contact" className="underline underline-offset-4">Contact</Link>
            {' page and we’ll connect you with the fulfilling dealer.'}
          </p>
        </section>
      </div>
    </div>
