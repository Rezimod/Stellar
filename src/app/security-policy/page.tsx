    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-12 sm:py-20 text-text-primary">
      ...
      <div className="flex flex-col gap-6 text-[15px] leading-relaxed text-text-primary/80">
        ...
        <section className="flex flex-col gap-2">
          <h2 className="font-display text-xl text-text-primary">How to report</h2>
          <p>
            {'Email '}
        ...
        <section className="flex flex-col gap-2">
          <h2 className="font-display text-xl text-text-primary">Please do</h2>
        ...
        <section className="flex flex-col gap-2">
          <h2 className="font-display text-xl text-text-primary">Please don’t</h2>
          <ul className="list-disc pl-5 flex flex-col gap-1.5">
        ...
        <section className="flex flex-col gap-2">
          <h2 className="font-display text-xl text-text-primary">What to expect</h2>
          <p>
