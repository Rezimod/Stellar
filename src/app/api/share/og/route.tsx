    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flex: 1, alignItems: 'center', justifyContent: 'center', gap: 64, padding: '0 64px' }}>
          ...
          {/* Divider */}
          <div style={{ width: 1, height: 200, background: 'rgba(227, 218, 201,0.15)' }} />
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 20 }}>
            ...
            <div
              style={{
                ...
                height: 120,
                borderRadius: '50%',
                border: '6px solid #E3DAC9',
                display: 'flex',
                flexDirection: 'column',
                alignItems: 'center',
                justifyContent: 'center',
                background: 'rgba(227, 218, 201,0.06)',
                boxShadow: '0 0 32px rgba(227, 218, 201,0.25)',
              }}
            >
              <span style={{ fontSize: 36, fontWeight: 700, color: '#E3DAC9', lineHeight: 1 }}>{score}</span>
              <span style={{ fontSize: 13, color: 'rgba(227, 218, 201,0.7)', marginTop: 2 }}>/ 100</span>
            </div>
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            />
            <span style={{ fontSize: 18, color: '#E3DAC9', fontWeight: 600 }}>Stellar</span>
          </div>
        </div>
      </div>
    ),
