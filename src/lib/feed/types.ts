...
export const REACTION_PICK_BG: Record<ReactionType, string> = {
  ...
  wow: 'radial-gradient(circle, rgba(227,218,201,0.3), transparent 70%)',
  ...
  star: 'radial-gradient(circle, rgba(227,218,201,0.35), transparent 70%)',
