...
export const REACTION_PICK_BG: Record<ReactionType, string> = {
  ...
  wow: 'radial-gradient(circle, rgba(255,179,71,0.3), transparent 70%)',
  ...
  star: 'radial-gradient(circle, rgba(255,179,71,0.35), transparent 70%)',
