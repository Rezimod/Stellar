...
export function TelescopeIcon({ size = 48, className, animate }: CelestialIconProps) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className}
      ...
      {/* lens glass inner */}
      <circle cx="36" cy="15" r="3.8" fill="rgba(153,69,255,0.18)" stroke="rgba(227, 218, 201,0.5)" strokeWidth="0.8"/>
      {/* glass reflex */}
...
export function StarTokenIcon({ size = 12, className }: { size?: number; className?: string }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 12 12" fill="none" className={className}
      style={{ display: 'inline-block', verticalAlign: 'middle', filter: 'drop-shadow(0 0 3px rgba(227, 218, 201,0.6)) drop-shadow(0 0 6px rgba(153,69,255,0.25))' }}>
      <defs>
...
export function DifficultyDots({ level }: { level: 1 | 2 | 3 | 4 }) {
  ...
  const color =
    ...
    : level === 3 ? 'rgba(227, 218, 201,0.8)'
    : 'rgba(227, 218, 201,0.7)';
