        ...
        >
          ...
          {DECOR_STARS.map((s, i) => (
            <circle
              ...
              cy={s.cy}
              r={s.r}
              fill={s.gold ? '#FFD166' : '#E8E6DD'}
              opacity={s.opacity}
            />
          ))}

          <circle cx="340" cy="230" r="32" fill="#FFD166" opacity="0.12" />
          <circle cx="340" cy="230" r="18" fill="#FFD166" opacity="0.3" />
          <circle cx="340" cy="230" r="9"  fill="#FFD166" opacity="1" />
          <text
            x="340"
            y="290"
            textAnchor="middle"
          ...
          <g className="cursor-pointer" onClick={goSky} role="link" aria-label="Observe — tonight's sky">
            <circle cx="340" cy="130" r="22" fill="#050811" stroke="#38F0FF" strokeWidth="1" />
            <circle cx="340" cy="130" r="4"  fill="#38F0FF" />
            <circle cx="335" cy="126" r="1.2" fill="rgba(56,240,255,0.6)" />
            <circle cx="344" cy="132" r="1"   fill="rgba(56,240,255,0.45)" />
            <circle cx="338" cy="135" r="0.9" fill="rgba(56,240,255,0.4)" />
            <text x="340" y="92" textAnchor="middle" fontSize="9" letterSpacing="0.2em" fill="#38F0FF" fontFamily="var(--font-mono)">
              i · OBSERVE
            </text>
            <text x="340" y="170" textAnchor="middle" fontSize="14" fill="#E8E6DD" fontFamily="var(--font-serif)">
              Tonight&apos;s sky
            </text>
          </g>
          ...
          <g className="cursor-pointer" onClick={goObserve} role="link" aria-label="Verify — photo and oracle">
            <circle cx="500" cy="230" r="20" fill="#050811" stroke="#FFD166" strokeWidth="1" />
            <path
            ...
            />
            <text x="540" y="222" textAnchor="start" fontSize="9" letterSpacing="0.2em" fill="#FFD166" fontFamily="var(--font-mono)">
              ii · VERIFY
            </text>
            <text x="540" y="240" textAnchor="start" fontSize="14" fill="#E8E6DD" fontFamily="var(--font-serif)">
              Photo + oracle
            </text>
          </g>
          ...
          <g className="cursor-pointer" onClick={goNfts} role="link" aria-label="Collect — NFT and Stars">
            <circle cx="180" cy="230" r="20" fill="#050811" stroke="#8465CB" strokeWidth="1" />
            <path
              ...
              strokeWidth="1.2"
            />
            <circle cx="180" cy="231" r="2" fill="#8465CB" />
            <text x="140" y="222" textAnchor="end" fontSize="9" letterSpacing="0.2em" fill="#8465CB" fontFamily="var(--font-mono)">
              iii · COLLECT
            </text>
            <text x="140" y="240" textAnchor="end" fontSize="14" fill="#E8E6DD" fontFamily="var(--font-serif)">
              NFT + Stars
            </text>
          </g>
