    ...
    <section className="py-16 md:py-24">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-[1fr_1.1fr] gap-8 md:gap-12 items-center">
        <div className="md:order-2">
          ...
          <Link
            href="/marketplace"
            className="mt-6 inline-flex items-center justify-center rounded-lg border-[0.5px] border-[rgba(232, 130, 107,0.3)] bg-[rgba(232, 130, 107,0.12)] px-5 py-2.5 text-[12px] font-medium text-[var(--terracotta)] transition-colors hover:bg-[rgba(232, 130, 107,0.18)]"
          >
            Browse marketplace  →
          </Link>
        </div>
        ...
        <div className="md:order-1 rounded-[14px] border-[0.5px] border-[rgba(232,230,221,0.08)] bg-[rgba(232,230,221,0.025)] p-[18px] md:p-[22px]">
          ...
          <div className="mt-3 flex items-center justify-between rounded-[10px] border-[0.5px] border-[rgba(232, 130, 107,0.2)] bg-[rgba(232, 130, 107,0.06)] p-[14px]">
...
function ProductCard({
  ...
  const styles =
    tone === 'gold'
      ? {
          wrap: 'border-[rgba(232, 130, 107,0.18)] bg-[rgba(232, 130, 107,0.06)]',
          chipOuter: 'bg-[rgba(232, 130, 107,0.18)]',
