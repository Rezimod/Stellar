...
export default function SkyAstraCta() {
  ...
  return (
    <Link
      ...
      style={{
        background: 'linear-gradient(135deg, rgba(232, 130, 107,0.06), rgba(26,143,160,0.03))',
        border: '1px solid rgba(232, 130, 107,0.12)',
      }}
    >
      <div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0"
        style={{ background: 'rgba(232, 130, 107,0.1)', border: '1px solid rgba(232, 130, 107,0.2)' }}>
