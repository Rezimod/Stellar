...
export default function PrimeHeroCard({ mission, altitude, tagline, onStart, magnitude, azimuth, riseSetLabel }: Props) {
  ...
  return (
    <div
      ...
      style={{
        background: 'linear-gradient(135deg, rgba(227, 218, 201,0.06), rgba(227, 218, 201,0.01) 60%, transparent)',
      ...
      <div className="flex-1 min-w-0 relative">
        ...
        {(magnitude != null || azimuth != null) && (
          ...
          >
            {magnitude != null && (
              <span>
                <span style={{ color: 'rgba(var(--ink), 0.35)', marginRight: 4 }}>MAG</span>
            ...
            {azimuth != null && (
              <span>
                <span style={{ color: 'rgba(var(--ink), 0.35)', marginRight: 4 }}>AZ</span>
                <span style={{ color: 'var(--text)', fontWeight: 600 }}>
                  {Math.round(azimuth)}°
                </span>
              </span>
