        ...
        <div className="flex items-center justify-between gap-2">
          <div className="flex-1 min-w-0">
            <div
              ...
              style={{
                background: conditionOk ? 'rgba(94, 234, 212,0.08)' : 'rgba(227, 218, 201,0.08)',
                border: `1px solid ${conditionOk ? 'rgba(94, 234, 212,0.2)' : 'rgba(227, 218, 201,0.2)'}`,
          ...
          <div className="grid grid-cols-3 gap-1">
            {metrics.map((m) => (
              <div key={m.label} className="rounded-lg px-2 py-1.5 flex flex-col gap-0.5"
                ...
                <div className="flex items-center gap-1" style={{ color: m.good ? 'rgba(var(--ink),0.3)' : 'rgba(227, 218, 201,0.5)' }}>
                  {m.icon}
                ...
                {m.bar !== null && (
                  <div className="h-0.5 rounded-full overflow-hidden" style={{ background: 'rgba(var(--ink),0.06)' }}>
                    <div className="h-full rounded-full" style={{
                      ...
                      background: m.good ? 'rgba(94, 234, 212,0.6)' : 'rgba(227, 218, 201,0.6)',
                    }} />
                  </div>
                )}
              </div>
            ...
            <div className="rounded-lg px-2 py-1.5 flex flex-col gap-0.5"
              style={{ background: 'rgba(var(--ink),0.03)', border: '1px solid rgba(var(--ink),0.05)' }}>
              <div className="flex items-center gap-1" style={{ color: 'rgba(227, 218, 201,0.55)' }}>
                <ShieldCheck size={12} />
        ...
        <button
          ...
          style={{
            ...
            background: stars > 0
              ...
              : 'linear-gradient(135deg, rgba(227, 218, 201,0.12), rgba(94, 234, 212,0.12))',
            color: stars > 0 ? 'var(--canvas)' : 'var(--terracotta)',
            border: stars > 0 ? 'none' : '1px solid rgba(227, 218, 201,0.25)',
            boxShadow: stars > 0 ? '0 0 24px rgba(227, 218, 201,0.2)' : '0 0 16px rgba(227, 218, 201,0.08)',
          }}
        >
