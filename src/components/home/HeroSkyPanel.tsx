      ...
      <svg viewBox="0 0 480 480" className="w-full h-auto block" fill="none">
        <defs>
          ...
          <radialGradient id="sun-corona" cx="50%" cy="50%" r="50%">
            <stop offset="0%"   stopColor="#E3DAC9" stopOpacity="0" />
            <stop offset="55%"  stopColor="#E3DAC9" stopOpacity="0.18" />
            <stop offset="80%"  stopColor="#FF9933" stopOpacity="0.10" />
            <stop offset="100%" stopColor="#E3DAC9" stopOpacity="0" />
          </radialGradient>
        ...
        <circle cx={CX} cy={CY} r={SUN_R} fill="none" stroke="#E3DAC9" strokeWidth="0.8" strokeOpacity="0.35" />
