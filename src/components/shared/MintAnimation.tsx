      ...
      <div className="relative flex items-center justify-center" style={{ width: 160, height: 160 }}>
        ...
        {!done && (
          <div className="absolute rounded-full animate-ping" style={{
            ...
            border: '1px solid rgba(232, 130, 107,0.07)',
        ...
        <div
          ...
          style={{
            ...
            border: `1px solid ${done ? 'rgba(94, 234, 212,0.25)' : 'rgba(232, 130, 107,0.14)'}`,
        ...
        >
          {!done && [0, 45, 90, 135, 180, 225, 270, 315].map(deg => (
            <div key={deg} style={{
              ...
              background: 'rgba(232, 130, 107,0.25)',
              top: '50%', left: '50%',
        ...
        {!done ? (
          <div
            ...
            style={{
              ...
              background: 'conic-gradient(from 0deg, transparent 65%, rgba(232, 130, 107,0.95) 83%, rgba(232, 130, 107,0.6) 100%)',
        ...
        {!done && (
          <div
            ...
            style={{
              ...
              background: 'conic-gradient(from 180deg, transparent 80%, rgba(232, 130, 107,0.4) 100%)',
        ...
        <div className="absolute rounded-full" style={{
          ...
          background: done
            ...
            : 'radial-gradient(circle, rgba(232, 130, 107,0.14) 0%, transparent 70%)',
        ...
        <div style={{ position: 'relative', width: 40, height: 40, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          {done ? (
            ...
            <div className="animate-pulse rounded-full" style={{
              ...
              boxShadow: '0 0 20px rgba(232, 130, 107,0.9), 0 0 40px rgba(232, 130, 107,0.35)',
            }} />
          )}
        </div>
      </div>
          ...
          <div className="flex justify-center gap-1.5 mt-1">
            {[0, 1, 2].map(i => (
              <div key={i} className="w-1 h-1 rounded-full animate-bounce"
                style={{ background: 'rgba(232, 130, 107,0.5)', animationDelay: `${i * 180}ms` }} />
            ))}
          </div>
        )}
        {slowMsg && !done && (
