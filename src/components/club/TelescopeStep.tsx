          ...
          {done ? (
            ...
            <div className="flex flex-col gap-3">
              ...
              <select value={form.brand} onChange={e => setForm(f => ({ ...f, brand: e.target.value }))}
                className="bg-[var(--surface)] border border-[rgba(232, 130, 107, 0.12)] rounded-lg px-3 py-2.5 text-text-primary text-sm focus:outline-none focus:border-[var(--terracotta)]">
              ...
              <input value={form.model} onChange={e => setForm(f => ({ ...f, model: e.target.value }))}
                ...
                className="bg-[var(--surface)] border border-[rgba(232, 130, 107, 0.12)] rounded-lg px-3 py-2.5 text-text-primary text-sm placeholder-slate-600 focus:outline-none focus:border-[var(--terracotta)]" />
