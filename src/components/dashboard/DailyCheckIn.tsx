    ...
    <>
      <style>{`
        ...
        @keyframes pulse-ring {
          0% { box-shadow: 0 0 0 0 rgba(227, 218, 201,0.4); }
          70% { box-shadow: 0 0 0 8px rgba(227, 218, 201,0); }
          100% { box-shadow: 0 0 0 0 rgba(227, 218, 201,0); }
        }
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
          ...
          >
            <Telescope size={14} color="rgba(227, 218, 201,0.7)" />
          </div>
          <div>
        ...
        <button
          ...
          style={{
            ...
            backgroundImage: loading
              ? 'linear-gradient(135deg, rgba(227, 218, 201,0.5), rgba(56,200,220,0.5))'
