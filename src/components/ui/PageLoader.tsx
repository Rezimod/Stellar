      ...
      <div style={{ position: 'relative', width: 120, height: 120 }}>
        ...
        <div
          style={{
            ...
            inset: -28,
            borderRadius: '50%',
            background: 'radial-gradient(circle, rgba(227, 218, 201,0.22) 0%, rgba(99,60,220,0.08) 50%, transparent 70%)',
        ...
        <div
          style={{
            ...
            marginLeft: -74,
            marginTop: -22,
            border: '2.5px solid rgba(227, 218, 201,0.45)',
            borderRadius: '50%',
            transform: 'rotateX(74deg)',
            boxShadow: '0 0 16px rgba(227, 218, 201,0.2)',
            zIndex: 1,
        ...
        <div
          style={{
            ...
            `,
            boxShadow: '0 0 32px rgba(227, 218, 201,0.55), 0 0 8px rgba(227, 218, 201,0.35), inset -8px -8px 20px rgba(0,0,0,0.5)',
            zIndex: 2,
            overflow: 'hidden',
          }}
        >
