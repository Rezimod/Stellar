...
const variantStyles: Record<CardVariant, React.CSSProperties> = {
  ...
  reward: {
    ...
    borderRadius: 'var(--radius-lg)',
    boxShadow: 'var(--shadow-glow-gold, 0 0 20px rgba(227, 218, 201,0.15)), inset 0 1px 0 rgba(var(--ink), 0.04)',
  },
  mission: {
    background: 'var(--bg-card)',
...
const glowMap: Record<string, string> = {
  teal:   '0 0 20px rgba(227, 218, 201,0.15)',
  gold:   '0 0 20px rgba(227, 218, 201,0.15)',
  ...
  const props: React.HTMLAttributes<HTMLElement> & { href?: string } = {
    ...
    onMouseEnter: isInteractive && hover
      ? (e) => {
          ...
          el.style.borderColor = 'rgba(227, 218, 201,0.1)';
